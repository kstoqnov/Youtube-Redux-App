...
class HomeTimes extends Component {
  ...
  render() {
    return (
      <HomeButtonContainer>
        <HomeButton onClick={() => this.props.fetchPastVideos(86400000)}>
          Yesterday
        </HomeButton>
        <HomeButton onClick={() => this.props.fetchPastVideos(604800000)}>
          last Week
        </HomeButton>
        <HomeButton onClick={() => this.props.fetchPastVideos(2592000000)}>
          last month
        </HomeButton>
        <HomeButton onClick={() => this.props.fetchPastVideos(864000000)}>
          All time
        </HomeButton>
      </HomeButtonContainer>
    );
